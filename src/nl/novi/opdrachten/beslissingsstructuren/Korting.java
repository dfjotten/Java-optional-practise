...
public class Korting {
    public static void main(String[] args) {
        ...
        if (aankoopBedrag < 75) {
            ...
            System.out.println( "De klant krijgt 10% korting. Het aankoopbedrag is nu: " + Math.floor(aankoopBedrag - (aankoopBedrag * 0.10)));
        } else {
            System.out.println( "De klant krijgt 16% korting. Het aankoopbedrag is nu: " + Math.floor(aankoopBedrag - (aankoopBedrag * 0.16)));
        }
